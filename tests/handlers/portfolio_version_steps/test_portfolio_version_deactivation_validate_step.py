...
class TestPortfolioVersionDeactivationValidateStep:
    ...
    def test_process_returns_ok_when_version_is_active(self, subject, portfolio_version, portfolio):
        ...
        assert result.value == f"Portfolio Version #{portfolio_version.id} is not active"

    def test_process_returns_error_when_version_is_not_active(self, subject, portfolio_version, portfolio):
