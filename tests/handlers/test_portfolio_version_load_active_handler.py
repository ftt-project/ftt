...
from ftt.handlers.portfolio_version_load_active_handler import PortfolioVersionLoadActiveHandler
...
class TestPortfolioVersionLoadActiveHandler:
    ...
    def test_process_returns_active_portfolio_version_by_portfolio_id(self, subject, portfolio_version_factory, portfolio):
        active_portfolio_version = portfolio_version_factory(portfolio=portfolio, version=1)
