...
class TestPortfolioCreationHandler:
    ...
    def test_creates_portfolio_with_empty_securities_list(self, subject, schema_portfolio):
    ...
    def test_creates_portfolio_with_securities_list(self, subject, schema_portfolio, security):
        result = subject.handle(
            portfolio=schema_portfolio,
            securities=[
